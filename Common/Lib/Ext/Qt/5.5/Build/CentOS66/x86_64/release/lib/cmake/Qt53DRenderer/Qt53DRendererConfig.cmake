...
macro(_populate_3DRenderer_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt53DRenderer_install_prefix}/lib/${LIB_LOCATION}")
    ...
    set_target_properties(Qt5::3DRenderer PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt53DRenderer.so.5"
...
if (NOT TARGET Qt5::3DRenderer)
    ...
    _populate_3DRenderer_target_properties(RELEASE "libQt53DRenderer.so.5.5.1" "" )
