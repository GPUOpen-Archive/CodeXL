...
macro(_populate_3DCollision_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt53DCollision_install_prefix}/lib/${LIB_LOCATION}")
    ...
    set_target_properties(Qt5::3DCollision PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt53DCollision.so.5"
...
if (NOT TARGET Qt5::3DCollision)
    ...
    _populate_3DCollision_target_properties(RELEASE "libQt53DCollision.so.5.5.1" "" )
