...
#include <AMDTOSAPIWrappers/Include/GLES/gl.h>
#include <AMDTOSAPIWrappers/Include/GLES/egltypes.h>
...
GLAPI NativeWindowType APIENTRY eglMakeWindowNV(NativeDisplayType disp, int x, int y, int w, int h);
GLAPI void APIENTRY eglDestroyWindowNV(NativeWindowType win);
