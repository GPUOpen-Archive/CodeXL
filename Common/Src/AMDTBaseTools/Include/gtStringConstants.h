...
#define GT_64_BIT_POINTER_ASCII_FORMAT_LOWERCASE "0x%016llx"
#define GT_64_BIT_POINTER_FORMAT_LOWERCASE L"0x%016llx"
#define GT_64_BIT_POINTER_FORMAT_UPPERCASE L"0x%016llX"
#define GT_32_BIT_POINTER_ASCII_FORMAT_LOWERCASE "0x%08x"
...
#define GT_UNSIGNED_INT_HEXADECIMAL_16_CHAR_FORMAT L"0x%016llx"
    ...
    #define GT_POINTER_FORMAT GT_64_BIT_POINTER_ASCII_FORMAT_LOWERCASE
#else
    #define GT_POINTER_FORMAT GT_32_BIT_POINTER_ASCII_FORMAT_LOWERCASE
