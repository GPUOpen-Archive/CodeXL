...
#define PM_STR_sharedProfileSettingsSystemWideProfileTooltip "Perform system-wide profile, collect profile data from all the current running processes. This profile scope is not supported only for all profile types."
...
#define PM_STR_sharedProfileSettingsEntireDurationTooltip "Click to collect the profile session data throughout entire duration"
#define PM_STR_sharedProfileSettingsProfilePaused "Start profile with data collection paused"
#define PM_STR_sharedProfileSettingsProfilePausedTooltip "Click to start the profile session without data collection. Data will be collected after clicking the 'Pause' button"
#define PM_STR_sharedProfileSettingsProfileScheduled "Scheduled:"
#define PM_STR_sharedProfileSettingsProfileScheduledTooltip "Click to specify the data collection start time offset and duration"
#define PM_STR_sharedProfileSettingsStartAfter "Start data collection after"
#define PM_STR_sharedProfileSettingsStartAfterTooltip "Click or type to set the time after start when data collection will start"
#define PM_STR_sharedProfileSettingsEndAfter "End data collection after"
#define PM_STR_sharedProfileSettingsEndAfterTooltip "Click to specify the data collection profile duration in seconds"
#define PM_STR_sharedProfileSettingsTerminateAfter "Then, terminate the process"
#define PM_STR_sharedProfileSettingsTerminateAfterTooltip "Click to terminate the executed application when the data collection ends."
...
#define PM_STR_sharedProfileSettingsCollectDataScheduleTooltip "Click to select the data collection schedule"
#define PM_STR_sharedProfileSettingsProfileScope "Profile Scope:"
#define PM_STR_sharedProfileSettingsProfileScopeTooltip "The profile scope defines the target on which the profile session will be preformed."
