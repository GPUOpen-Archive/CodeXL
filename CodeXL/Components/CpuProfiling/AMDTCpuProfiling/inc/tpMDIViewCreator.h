...
/// \file tpMDIViewCreator.h
///
//==================================================================================

//------------------------------ tpMDIViewCreator.h ------------------------------

#ifndef __TPMDIVIEWCREATOR_H
#define __TPMDIVIEWCREATOR_H
...
// ----------------------------------------------------------------------------------
// Class Name:           tpMDIViewCreator : public afQtViewCreatorAbstract
// General Description:  This class is handling the creation of MDI views for the thread profile
//                       plug-in
// ----------------------------------------------------------------------------------
class tpMDIViewCreator : public afQtViewCreatorAbstract
{
public:

    ~tpMDIViewCreator();

    static tpMDIViewCreator& Instance();
    ...
    virtual const gtString CreatedMDIType() const { return AF_STR_ThreadProfileViewsCreatorID; }
...
private:
    ...
    static tpMDIViewCreator* m_spMySingleInstance;
