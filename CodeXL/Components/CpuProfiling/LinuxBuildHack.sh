...
# The format of this will be: CpuProfiling-yyyy-mm-dd-v<major>.<minor>.<build>.tar.gz
# The directory layout
# top level.../OpenCLDebugAPI (where the final .tar.gz resides)
#   LinuxTarDir
#       API Doc
#       Readme
#       --> Include
...
# First: build the x86 and x86_64 versions in both debug and release modes
...
exit 0
# rgorton - 12-June-2012 - this won't build for a while, so simply leave some of these
# cloned bits in place until the content becomes more obvious
