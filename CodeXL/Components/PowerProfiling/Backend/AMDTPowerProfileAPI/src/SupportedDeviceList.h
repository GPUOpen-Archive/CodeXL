...
PciDeviceInfo g_deviceTable[PWR_MAX_DEVICE_LIST_SIZE] =
{
    ...
    { GDT_SPECTRE, 0x1305, DEVICE_TYPE_APU, "Spectre", "KV SPECTRE DESKTOP 95W (1305)", "Kaveri", SMU_IPVERSION_7_0},
    { GDT_SPECTRE_SL, 0x1306, DEVICE_TYPE_APU, "Spectre", "KV SPECTRE SL MOBILE 35W (1306)", "Kaveri", SMU_IPVERSION_7_0},
    { GDT_SPECTRE_SL, 0x1307, DEVICE_TYPE_APU, "Spectre", "KV SPECTRE SL DESKTOP 95W (1307)", "Kaveri", SMU_IPVERSION_7_0},
    { GDT_SPECTRE_LITE, 0x1309, DEVICE_TYPE_APU, "Spectre", "AMD Radeon(TM) R7 Graphics", "Kaveri", SMU_IPVERSION_7_0},
    { GDT_SPECTRE_LITE, 0x130A, DEVICE_TYPE_APU, "Spectre", "AMD Radeon(TM) R6 Graphics", "Kaveri", SMU_IPVERSION_7_0},
    { GDT_SPECTRE_SL, 0x130B, DEVICE_TYPE_APU, "Spectre", "AMD Radeon(TM) R4 Graphics", "Kaveri", SMU_IPVERSION_7_0},
    { GDT_SPECTRE, 0x130C, DEVICE_TYPE_APU, "Spectre", "AMD Radeon(TM) R7 Graphics", "Kaveri", SMU_IPVERSION_7_0},
    { GDT_SPECTRE_LITE, 0x130D, DEVICE_TYPE_APU, "Spectre", "AMD Radeon(TM) R6 Graphics", "Kaveri", SMU_IPVERSION_7_0},
    { GDT_SPECTRE_SL, 0x130E, DEVICE_TYPE_APU, "Spectre", "AMD Radeon(TM) R5 Graphics", "Kaveri", SMU_IPVERSION_7_0},
    { GDT_SPECTRE, 0x130F, DEVICE_TYPE_APU, "Spectre", "AMD Radeon(TM) R7 Graphics", "Kaveri", SMU_IPVERSION_7_0},
    { GDT_SPECTRE, 0x1310, DEVICE_TYPE_APU,  "Spectre", "KV SPECTRE WORKSTATION 65W (1310)", "Kaveri", SMU_IPVERSION_7_0},
    { GDT_SPECTRE, 0x1311, DEVICE_TYPE_APU,  "Spectre", "KV SPECTRE WORKSTATION 95W (1311)", "Kaveri", SMU_IPVERSION_7_0},
    { GDT_SPECTRE_LITE, 0x1313, DEVICE_TYPE_APU,  "Spectre", "AMD Radeon(TM) R7 Graphics", "Kaveri", SMU_IPVERSION_7_0},
    { GDT_SPECTRE_SL, 0x1315, DEVICE_TYPE_APU,  "Spectre", "AMD Radeon(TM) R5 Graphics", "Kaveri", SMU_IPVERSION_7_0},
    { GDT_SPECTRE_SL, 0x1318, DEVICE_TYPE_APU,  "Spectre", "AMD Radeon(TM) R5 Graphics", "Kaveri", SMU_IPVERSION_7_0},
    { GDT_SPECTRE_SL, 0x131B, DEVICE_TYPE_APU,  "Spectre", "AMD Radeon(TM) R4 Graphics", "Kaveri", SMU_IPVERSION_7_0},
    { GDT_SPECTRE, 0x131C, DEVICE_TYPE_APU,  "Spectre", "AMD Radeon(TM) R7 Graphics", "Kaveri", SMU_IPVERSION_7_0},
    { GDT_SPECTRE_LITE, 0x131D, DEVICE_TYPE_APU,  "Spectre", "AMD Radeon(TM) R6 Graphics", "Kaveri", SMU_IPVERSION_7_0},
    ...
    // Godavari
    { GDT_SPECTRE, 0x1422, DEVICE_TYPE_APU,  "Spectre", "Kaveri", "Godavari", SMU_IPVERSION_7_0},

    // Beema
    { GDT_KALINDI, 0x9850, DEVICE_TYPE_APU,  "Mullins", "AMD Radeon(TM) R3 Graphics", "FT3 socket", SMU_IPVERSION_7_0},
    { GDT_KALINDI, 0x9851, DEVICE_TYPE_APU,  "Mullins", "AMD Radeon(TM) R4 Graphics", "FT3 socket", SMU_IPVERSION_7_0},
    { GDT_KALINDI, 0x9852, DEVICE_TYPE_APU,  "Mullins", "AMD Radeon(TM) R2 Graphics", "FT3 socket", SMU_IPVERSION_7_0},
    { GDT_KALINDI, 0x9853, DEVICE_TYPE_APU,  "Mullins", "AMD Radeon(TM) R2 Graphics", "FT3 socket", SMU_IPVERSION_7_0},
    { GDT_KALINDI, 0x9854, DEVICE_TYPE_APU,  "Mullins", "AMD Radeon(TM) R3 Graphics", "FT3 socket", SMU_IPVERSION_7_0},
    { GDT_KALINDI, 0x9855, DEVICE_TYPE_APU,  "Mullins", "AMD Radeon(TM) R6 Graphics", "FT3 socket", SMU_IPVERSION_7_0},
    { GDT_KALINDI, 0x9856, DEVICE_TYPE_APU,  "Mullins", "AMD Radeon(TM) R2 Graphics", "FT3 socket", SMU_IPVERSION_7_0},
    { GDT_KALINDI, 0x9857, DEVICE_TYPE_APU,  "Mullins", "AMD Radeon APU XX-2200M with R2 Graphics", "FT3 socket", SMU_IPVERSION_7_0},
    { GDT_KALINDI, 0x9858, DEVICE_TYPE_APU,  "Mullins", "MULLINS (9858)", "FT3 socket", SMU_IPVERSION_7_0},
    { GDT_KALINDI, 0x9859, DEVICE_TYPE_APU,  "Mullins", "MULLINS (9859)", "FT3 socket", SMU_IPVERSION_7_0},
    { GDT_KALINDI, 0x985A, DEVICE_TYPE_APU,  "Mullins", "MULLINS (985A)", "FT3 socket", SMU_IPVERSION_7_0},
    { GDT_KALINDI, 0x985B, DEVICE_TYPE_APU,  "Mullins", "MULLINS (985B)", "FT3 socket", SMU_IPVERSION_7_0},
    { GDT_KALINDI, 0x985C, DEVICE_TYPE_APU,  "Mullins", "MULLINS (985C)", "FT3 socket", SMU_IPVERSION_7_0},
    { GDT_KALINDI, 0x985D, DEVICE_TYPE_APU,  "Mullins", "MULLINS (985D)", "FT3 socket", SMU_IPVERSION_7_0},
    { GDT_KALINDI, 0x985E, DEVICE_TYPE_APU,  "Mullins", "MULLINS (985E)", "FT3 socket", SMU_IPVERSION_7_0},
    { GDT_KALINDI, 0x985F, DEVICE_TYPE_APU,  "Mullins", "MULLINS (985F)", "FT3 socket", SMU_IPVERSION_7_0},

    // Carrizo -- OCL uses "Peacock" on mainline currently
    { GDT_CARRIZO, 0x9870, DEVICE_TYPE_APU, "Carrizo", "CARRIZO 9870", "Palladium", SMU_IPVERSION_8_0},
    { GDT_CARRIZO, 0x9874, DEVICE_TYPE_APU, "Carrizo", "CARRIZO 9874", "CARRIZO 9874", SMU_IPVERSION_8_0},
    { GDT_CARRIZO, 0x9875, DEVICE_TYPE_APU, "Carrizo", "CARRIZO 9875", "CARRIZO 9875", SMU_IPVERSION_8_0},
    { GDT_CARRIZO, 0x9876, DEVICE_TYPE_APU, "Carrizo", "CARRIZO 9876", "CARRIZO 9876", SMU_IPVERSION_8_0},
    { GDT_CARRIZO, 0x9877, DEVICE_TYPE_APU, "Carrizo", "CARRIZO 9877", "CARRIZO 9877", SMU_IPVERSION_8_0},
