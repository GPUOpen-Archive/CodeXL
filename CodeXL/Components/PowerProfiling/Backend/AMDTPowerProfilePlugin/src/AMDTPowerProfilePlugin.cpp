...
/// \file AMDTPowerProfilePlugin.cpp
///
//==================================================================================
#include <windows.h>
#include <Sddl.h>
...
#include <AMDTPowerProfilePlugin.h>
...
extern "C"
int amdtPowerBeginMarker(const char* szMarkerName, unsigned char* buffer)
{
    int ret = 0;
    MarkerTag marker;
...
extern "C"
int amdtPowerEndMarker(const char* szMarkerName)
{
    int ret = 0;
    MarkerTag marker;
