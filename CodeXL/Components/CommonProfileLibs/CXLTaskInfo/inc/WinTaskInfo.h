...
public:
    ...
    // Get instance id of a module from ip address, pid and time stamp
...
private:
    ...
    // During profile data collection, the TI contains information about all the processes
