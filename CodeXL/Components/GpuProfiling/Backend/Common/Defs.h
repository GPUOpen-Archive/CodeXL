...
// @{
    ...
    #else
        #define GPU_PROFILER_LIBRARY_NAME_PREFIX "AMDTGpuProfiler"
    #endif
#else
    #define GPU_PROFILER_LIBRARY_NAME_PREFIX "CXLGpuProfiler"
#endif

#define CL_TRACE_AGENT_DLL LIB_PREFIX GPU_PROFILER_LIBRARY_NAME_PREFIX "CLTraceAgent" BITNESS DEBUG_PREFIX AMDT_BUILD_SUFFIX LIB_SUFFIX
#define CL_SUB_KERNEL_PROFILE_AGENT_DLL LIB_PREFIX GPU_PROFILER_LIBRARY_NAME_PREFIX "CLSubKernelProfileAgent" BITNESS DEBUG_PREFIX AMDT_BUILD_SUFFIX LIB_SUFFIX
#define CL_PROFILE_AGENT_DLL LIB_PREFIX GPU_PROFILER_LIBRARY_NAME_PREFIX "CLProfileAgent" BITNESS DEBUG_PREFIX AMDT_BUILD_SUFFIX LIB_SUFFIX
#define CL_OCCUPANCY_AGENT_DLL LIB_PREFIX GPU_PROFILER_LIBRARY_NAME_PREFIX "CLOccupancyAgent" BITNESS DEBUG_PREFIX AMDT_BUILD_SUFFIX LIB_SUFFIX
#define CL_THREAD_TRACE_AGENT_DLL LIB_PREFIX GPU_PROFILER_LIBRARY_NAME_PREFIX "CLThreadTraceAgent" BITNESS DEBUG_PREFIX AMDT_BUILD_SUFFIX LIB_SUFFIX

#define HSA_TRACE_AGENT_DLL LIB_PREFIX GPU_PROFILER_LIBRARY_NAME_PREFIX "HSATraceAgent" BITNESS DEBUG_PREFIX AMDT_BUILD_SUFFIX LIB_SUFFIX
#define HSA_PROFILE_AGENT_DLL LIB_PREFIX GPU_PROFILER_LIBRARY_NAME_PREFIX "HSAProfileAgent" BITNESS DEBUG_PREFIX AMDT_BUILD_SUFFIX LIB_SUFFIX
...
#ifdef WIN32
    #define DC_SERVER_DLL LIB_PREFIX GPU_PROFILER_LIBRARY_NAME_PREFIX "DCServer" BITNESS DEBUG_PREFIX AMDT_BUILD_SUFFIX LIB_SUFFIX
    #define MICRO_DLL LIB_PREFIX GPU_PROFILER_LIBRARY_NAME_PREFIX "MicroDll" BITNESS DEBUG_PREFIX AMDT_BUILD_SUFFIX LIB_SUFFIX
#elif defined (__linux__) || defined (_LINUX) || defined(LINUX)
    #define PRELOAD_XINITTHREADS_LIB LIB_PREFIX GPU_PROFILER_LIBRARY_NAME_PREFIX "PreloadXInitThreads" BITNESS DEBUG_PREFIX AMDT_BUILD_SUFFIX LIB_SUFFIX
#endif
