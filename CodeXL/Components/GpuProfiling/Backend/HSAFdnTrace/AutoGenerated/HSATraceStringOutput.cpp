...
std::string HSATraceStringUtils::Get_hsa_ext_image_descriptor_t_String(hsa_ext_image_descriptor_t input)
{
    ...
    ss << HSATraceStringUtils::Get_size_t_String(input.width) << s_pFieldSeparator;
    ss << HSATraceStringUtils::Get_size_t_String(input.height) << s_pFieldSeparator;
    ss << HSATraceStringUtils::Get_size_t_String(input.depth) << s_pFieldSeparator;
    ss << HSATraceStringUtils::Get_size_t_String(input.array_size) << s_pFieldSeparator;
...
std::string HSATraceStringUtils::Get_hsa_ext_image_data_info_t_String(hsa_ext_image_data_info_t input)
{
    ...
    ss << HSATraceStringUtils::Get_size_t_String(input.size) << s_pFieldSeparator;
    ss << HSATraceStringUtils::Get_size_t_String(input.alignment);
...
std::string HSATraceStringUtils::Get_hsa_amd_memory_pool_link_info_t_String(hsa_amd_memory_pool_link_info_t input)
{
    ...
    ss << HSATraceStringUtils::Get_bool_String(input.atomic_support_32bit) << s_pFieldSeparator;
    ss << HSATraceStringUtils::Get_bool_String(input.atomic_support_64bit) << s_pFieldSeparator;
    ss << HSATraceStringUtils::Get_bool_String(input.coherent_support) << s_pFieldSeparator;
