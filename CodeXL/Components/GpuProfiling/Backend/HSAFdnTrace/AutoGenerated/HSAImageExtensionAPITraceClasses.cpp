...
std::string HSA_APITrace_hsa_ext_image_get_capability::ToString()
{
    ...
    ss << StringUtils::ToString(m_capability_mask, m_capability_maskVal);
    return ss.str();
}
...
std::string HSA_APITrace_hsa_ext_image_import::ToString()
{
    ...
    ss << HSATraceStringUtils::Get_size_t_String(m_src_row_pitch) << s_strParamSeparator;
    ss << HSATraceStringUtils::Get_size_t_String(m_src_slice_pitch) << s_strParamSeparator;
    ss << HSATraceStringUtils::Get_hsa_ext_image_t_String(m_dst_image) << s_strParamSeparator;
...
std::string HSA_APITrace_hsa_ext_image_export::ToString()
{
    ...
    ss << HSATraceStringUtils::Get_size_t_String(m_dst_row_pitch) << s_strParamSeparator;
    ss << HSATraceStringUtils::Get_size_t_String(m_dst_slice_pitch) << s_strParamSeparator;
    ss << HSATraceStringUtils::Get_hsa_ext_image_region_t_Ptr_String(m_image_region, m_image_regionVal);
    return ss.str();
}
