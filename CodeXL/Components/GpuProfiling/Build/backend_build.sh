...
ADDITIONAL_COMPILER_DEFINES_OVERRIDE=
...
HSAUTILS="$SPROOT/Backend/HSAUtils"
...
HSAUTILSLIB="lib${GPU_PROFILER_LIB_PREFIX}HSAUtils$DEBUG_SUFFIX.a"
HSAUTILSLIB32="lib${GPU_PROFILER_LIB_PREFIX}HSAUtils$DEBUG_SUFFIX.a"
