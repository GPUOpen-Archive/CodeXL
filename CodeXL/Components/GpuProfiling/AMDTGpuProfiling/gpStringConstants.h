...
#define GPU_STR_dashboard_CaptureCPUTooltip "Capture %1 CPU frames for analysis"
#define GPU_STR_dashboard_CaptureGPUTooltip "Capture %1 GPU frames for analysis"
