...
public:
    ...
    bool InsertJitInstance(gtUInt32 jitId, gtUInt64 functionId, gtUInt64 pid, gtUInt64 loadAddr, gtUInt32 size);
    //bool InsertJitCodeBlob(gtUInt32 id, const gtString& sourceFilePath, gtUByte *pBlob, gtUInt32 blobLength);
    bool InsertJitCodeBlob(gtUInt32 id, const gtString& sourceFilePath, const gtString& jncFilePath);
