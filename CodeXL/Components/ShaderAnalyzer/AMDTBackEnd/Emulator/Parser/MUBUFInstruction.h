...
public:
    ...
    MUBUFInstruction(OFFSET offset, OFFEN offen, IDXEN idxen, GLC glc, ADDR64 addr64, LDS lds, VADDR vaddr, VDATA vdata, SRSRC srsrc,
                     SLC slc, TFE tfe, SOFFSET soffset, unsigned int ridx, Instruction::InstructionCategory inst, int iLabel, int iGotoLabel): Instruction(MUBUFInstructionWidth, inst, InstructionSet_MUBUF, iLabel, iGotoLabel),
...
public:
    ...
    SIMUBUFInstruction(OFFSET offset, OFFEN offen, IDXEN idxen, GLC glc, ADDR64 addr64, LDS lds, OP op, VADDR vaddr, VDATA vdata, SRSRC srsrc,
                       SLC slc, TFE tfe, SOFFSET soffset, unsigned int ridx, Instruction::InstructionCategory inst, int iLabel, int iGotoLabel): MUBUFInstruction(offset, offen, idxen, glc, addr64, lds, vaddr, vdata, srsrc,
                                   slc, tfe, soffset, ridx, inst, iLabel, iGotoLabel), m_op(op) {}
