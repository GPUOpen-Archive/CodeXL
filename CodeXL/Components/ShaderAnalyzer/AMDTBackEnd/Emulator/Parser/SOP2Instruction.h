...
public:
    ...
    /// ctor
    SOP2Instruction(SSRC ssrc0, SSRC ssrc1, SDST sdst, unsigned int sridx0, unsigned int sridx1, unsigned int sdstRidx, bool isLiteral32bit = false, uint32_t literal32bit = 0, int iLabel = NO_LABEL, int iGotoLabel = NO_LABEL): Instruction(SOPCInstructionWidth, ScalarALU, InstructionSet_SOP2, iLabel, iGotoLabel),
