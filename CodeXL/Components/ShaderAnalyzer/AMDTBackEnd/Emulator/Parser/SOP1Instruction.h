...
public:
    ...
    /// ctor
    SOP1Instruction(SSRC ssrc0, SDST sdst, unsigned int sridx0, unsigned int sdstRidx, int iLabel, int iGotoLabel): Instruction(SOP1InstructionWidth, ScalarALU, InstructionSet_SOP1, iLabel, iGotoLabel),
...
public:
    ...
    /// ctor
    SISOP1Instruction(SSRC ssrc0, OP op, SDST sdst, unsigned int sridx0, unsigned int sdstRidx, int iLabel, int iGotoLabel): SOP1Instruction(ssrc0, sdst, sridx0, sdstRidx, iLabel, iGotoLabel), m_op(op) { }
private:
    /// SOP1 operation.
    OP m_op;
...
public:
    ...
    /// ctor
    VISOP1Instruction(SSRC ssrc0, OP op, SDST sdst, unsigned int sridx0, unsigned int sdstRidx, int iLabel, int iGotoLabel): SOP1Instruction(ssrc0, sdst, sridx0, sdstRidx, iLabel, iGotoLabel), m_op(op)
    {
