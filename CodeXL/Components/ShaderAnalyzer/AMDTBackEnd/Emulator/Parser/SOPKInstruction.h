...
public:
    ...
    /// ctor
    SOPKInstruction(SIMM16 simm16, SDST sdst, unsigned int simm16Ridx, unsigned int sdstRidx, int iLabel, int iGotoLabel): Instruction(SOPKInstructionWidth, ScalarALU, InstructionSet_SOPK, iLabel, iGotoLabel),
...
public:
    ...
    /// ctor
    SISOPKInstruction(SIMM16 simm16, OP op, SDST sdst, unsigned int simm16Ridx, unsigned int sdstRidx, int iLabel, int iGotoLabel): SOPKInstruction(simm16, sdst, simm16Ridx, sdstRidx, iLabel, iGotoLabel), m_op(op) { }
...
public:
    ...
    /// ctor
    VISOPKInstruction(SIMM16 simm16, OP op, SDST sdst, unsigned int simm16Ridx, unsigned int sdstRidx, int iLabel, int iGotoLabel): SOPKInstruction(simm16, sdst, simm16Ridx, sdstRidx, iLabel, iGotoLabel), m_op(op)
    {
