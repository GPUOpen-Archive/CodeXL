...
rem xcopy /r /d /y %VSIX_COPY_COMMON_FOLDER%Lib\AMD\GPUPerfAPI\2_21\Bin\x86\GPUPerfAPICounters.dll %VSIX_COPY_TARGET_DIR%x86\
rem xcopy /r /d /y %VSIX_COPY_COMMON_FOLDER%Lib\AMD\GPUPerfAPI\2_21\Bin\x64\GPUPerfAPICounters-x64.dll %VSIX_COPY_TARGET_DIR%x64\
