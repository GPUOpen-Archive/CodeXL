//------------------------------ vspPowerProfilingEditorDocument.cpp ------------------------------
...
// Local:
#include <src/vspPowerProfilingEditorDocument.h>
...
// ---------------------------------------------------------------------------
// Name:        vspPowerProfilingEditorDocument::CreatePaneWindow
// Description: Our implementation for the custom editor CreatePaneWindow
// Arguments:   _In_ HWND hWndParent
//              _In_ int x
//              _In_ int y
//              _In_ int cx
//              _In_ int cy
...
// ---------------------------------------------------------------------------
// **DONE**
STDMETHODIMP vspPowerProfilingEditorDocument::CreatePaneWindow(_In_ HWND hWndParent, _In_ int x, _In_ int y, _In_ int cx, _In_ int cy, _Out_ HWND* phWnd)
{
    VSL_STDMETHODTRY
    {
        ...
        vscPowerProfilingEditorDocument_CreatePaneWindow(m_pCoreImpl, hWndParent, x, y, cx, cy, phWnd);
...
// ---------------------------------------------------------------------------
// Name:        vspPowerProfilingEditorDocument::LoadDocData
...
// ---------------------------------------------------------------------------
// **DONE**
STDMETHODIMP vspPowerProfilingEditorDocument::LoadDocData(_In_ LPCOLESTR pszMkDocument)
{
    VSL_STDMETHODTRY
    {
...
// ---------------------------------------------------------------------------
// Name:        vspPowerProfilingEditorDocument::setEditorCaption
...
// ---------------------------------------------------------------------------
// **DONE**
bool vspPowerProfilingEditorDocument::setEditorCaption(const wchar_t* filePath)
{
    bool retVal = false;
    ...
    if (spIVsWindowFrame != NULL)
    {
        ...
        vscPowerProfilingEditorDocument_SetEditorCaptionCoreLogic(m_pCoreImpl, filePath, itemNameStr);
        ...
        // Release the string.
        vscDeleteWcharString(itemNameStr);
...
// **DONE**
STDMETHODIMP vspPowerProfilingEditorDocument::GetDefaultSize(_Out_ SIZE* psize)
{
    VSL_STDMETHODTRY
    {
...
// **DONE**
STDMETHODIMP vspPowerProfilingEditorDocument::ClosePane()
{
    if (m_bClosed)
    {
        // recursion guard
    ...
    VSL_STDMETHODTRY
    {
        ...
        // Invoke the core logic.
        vscPowerProfilingEditorDocument_ClosePane(m_pCoreImpl);
...
// ---------------------------------------------------------------------------
// Name:        vspPowerProfilingEditorDocument::OnSize
...
// ---------------------------------------------------------------------------
// **DONE**
STDMETHODIMP vspPowerProfilingEditorDocument::OnSize(int x, int y, int w, int h)
{
...
// ---------------------------------------------------------------------------
// **DONE**
STDMETHODIMP vspPowerProfilingEditorDocument::OnShow(FRAMESHOW fShow)
{
    HRESULT retVal = S_OK;
    ...
    {
        // Invoke the core logic:
        vscPowerProfilingEditorDocument_OnShow(m_pCoreImpl);
...
*/
// **DONE**
LRESULT vspPowerProfilingEditorDocument::OnUserInteractionEvent(int /*wParam*/, _In_ LPNMHDR pHeader, BOOL& /*bHandled*/)
{
...
// **DONE**
LRESULT vspPowerProfilingEditorDocument::OnSetFocus(UINT /*uMsg*/, _In_ WPARAM /*wParam*/, _In_ LPARAM /*lParam*/, BOOL& bHandled)
{
...
// ---------------------------------------------------------------------------
// Name:        vspPowerProfilingEditorDocument::onQueryCopyAction
...
// ---------------------------------------------------------------------------
// **DONE**
void vspPowerProfilingEditorDocument::onQueryCopyAction(const CommandHandler& rSender, _Inout_ OLECMD* pOleCmd, _Inout_ OLECMDTEXT* pOleText)
{
    ...
    // Invoke the core logic:
    vscPowerProfilingEditorDocument_OnUpdateEdit_Copy(m_pCoreImpl, canCopy);
...
// ---------------------------------------------------------------------------
// Name:        vspPowerProfilingEditorDocument::onQuerySelectAllAction
...
// ---------------------------------------------------------------------------
// **DONE**
void vspPowerProfilingEditorDocument::onQuerySelectAllAction(const CommandHandler& rSender, _Inout_ OLECMD* pOleCmd, _Inout_ OLECMDTEXT* pOleText)
{
    GT_UNREFERENCED_PARAMETER(&rSender);
    GT_UNREFERENCED_PARAMETER(pOleText);
...
// ---------------------------------------------------------------------------
// Name:        vspPowerProfilingEditorDocument::onCopyAction
...
// ---------------------------------------------------------------------------
// **DONE**
void vspPowerProfilingEditorDocument::onCopyAction(_In_ CommandHandler* pSender, DWORD flags, _In_ VARIANT* pIn, _Out_ VARIANT* pOut)
{
...
// ---------------------------------------------------------------------------
// Name:        vspPowerProfilingEditorDocument::onSelectAllAction
...
// ---------------------------------------------------------------------------
// **DONE**
void vspPowerProfilingEditorDocument::onSelectAllAction(_In_ CommandHandler* pSender, DWORD flags, _In_ VARIANT* pIn, _Out_ VARIANT* pOut)
{
    GT_UNREFERENCED_PARAMETER(pSender);
    GT_UNREFERENCED_PARAMETER(flags);
    GT_UNREFERENCED_PARAMETER(pIn);
...
// **DONE**
HRESULT vspPowerProfilingEditorDocument::ReadData(
    File& rFile,
    BOOL bInsert,
...
// **DONE**
void vspPowerProfilingEditorDocument::WriteData(File& rFile, DWORD /*dwFormatIndex*/)
{
...
DWORD CALLBACK vspPowerProfilingEditorDocument::EditStreamCallback(
...
// **DONE**
bool vspPowerProfilingEditorDocument::IsValidFormat(DWORD dwFormatIndex)
{
...
// **DONE**
void vspPowerProfilingEditorDocument::OnFileChangedSetTimer()
{
    // 500 milliseconds is an arbitrary time to delay
    // See vspPowerProfilingEditorDocument::OnTimer and
...
// **DONE**
const GUID& vspPowerProfilingEditorDocument::GetEditorTypeGuid() const
{
    // The GUID for the factory is the one to return from IPersist::GetClassID and
    // IVsPersistDocData::GetGuidEditorType
    return CLSID_CodeXLVSPackagePowerProfilingEditorFactory;
}

// Called by VSL::DocumentPersistanceBase::GetFormatList
// **DONE**
void vspPowerProfilingEditorDocument::GetFormatListString(ATL::CStringW& rstrFormatList)
{
...
// **DONE**
void vspPowerProfilingEditorDocument::PostSetDirty()
{
