...
[$RootKey$\Editors\{43946143-BAB8-41D6-968C-BBA70DB6E6D1}]
@="CodeXLVSPackage"
...
[$RootKey$\Editors\{43946143-BAB8-41D6-968C-BBA70DB6E6D1}\LogicalViews]
"{7651A703-06E5-11D1-8EBD-00A0C90F26EA}"=""

[$RootKey$\Editors\{43946143-BAB8-41D6-968C-BBA70DB6E6D1}\Extensions]
...
CodeXLVSPackagePackage::PostSited creates an instance of EditorFactory and then queries
...
#pragma warning(pop)
        ...
        VSEDITORCREATEDOCWIN& /*rCreateDocumentWindowUI*/)
    {
        ...
        {
            CComObject<vspImageAndBuffersEditorDocument>* pDocument;
            VSL_CHECKHRESULT(CComObject<vspImageAndBuffersEditorDocument>::CreateInstance(&pDocument));
            ...
            rpguidCommandUI = &CLSID_CodeXLVSPackageEditorDocument;
