...
namespace CodeXLVSPackageVSIX
{
    ...
    internal sealed class OpenCLCClassifier : ITagger<ClassificationTag>
    {
        ...
        static HashSet<string> hashedKeywords = new HashSet<string>(openclCKeywords.ToList());
        static HashSet<string> hashedBuiltInValues = new HashSet<string>(openclBuiltInValues.ToList());
        ...
        public IEnumerable<ITagSpan<ClassificationTag>> GetTags(NormalizedSnapshotSpanCollection spans)
        {
            foreach (SnapshotSpan curSpan in spans)
            {
                ...
                foreach (string strToken in tokens)
                {
                    ...
                    {
                        bool isKeyWord = hashedKeywords.Contains(strToken);
                        bool isBuiltInValue = hashedBuiltInValues.Contains(strToken);
