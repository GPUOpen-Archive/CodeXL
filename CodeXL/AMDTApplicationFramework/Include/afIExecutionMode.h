...
enum afExecutionCommandId
{
    ...
    AF_EXECUTION_ID_CAPTURE,
    AF_EXECUTION_ID_CAPTURE_CPU,
    AF_EXECUTION_ID_CAPTURE_GPU,
...
enum afStartupAction
{
    ...
    AF_NO_PROJECT_USER_ACTION_CPU_PROFILE_SYSTEM_WIDE,
    AF_NO_PROJECT_USER_ACTION_CPU_PROFILE_ATTACH_TO_PROCESS,
    AF_NO_PROJECT_USER_ACTION_CREATE_NEW_PROJECT_FRAME_ANALYZE,
