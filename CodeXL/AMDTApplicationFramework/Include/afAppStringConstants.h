...
#define AF_STR_HelpDevToolsSupportForum L"AMD &CodeXL Support Forum"
...
#define AF_STR_HelpDevToolsSupportForumStatusbarString L"Go to the CodeXL Support Forum"
